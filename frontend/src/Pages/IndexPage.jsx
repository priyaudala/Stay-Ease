...
const IndexPage = () => {
  ...
  return (
    <>
      ...
      {currentList.length === 0 && !loading && searchInput && (
        <h3 className="text-2xl text-pink font-semibold text-center mx-auto w-[400px] sm:w-[700px] mt-8">
          Oops, we couldn’t find any results for your search. Try again with different keywords?
        </h3>
      )}
    </>
  );
